...
- 使用改进的YOLOv5进行红外图像目标检测（行人、车辆、自行车）
- 实现并对比多种跟踪算法（DeepSORT、ByteTrack、CenterTrack）
- 将模型部署到RV1126嵌入式平台

**数据集**: 本项目使用 **FLIR ADAS v2 热红外数据集**

## 📚 快速导航

- 🚀 [快速开始指南](QUICKSTART.md) - 5步完成环境搭建和模型训练
- 📊 [数据处理详细指南](DATA_PROCESSING_GUIDE.md) - FLIR数据集处理完整教程
- 📖 [项目结构说明](#项目结构) - 了解项目各部分功能
- 🛠️ [详细使用说明](#快速开始) - 完整的使用流程
