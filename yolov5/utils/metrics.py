...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, EIoU=False, eps=1e-7):
    """Calculates IoU, GIoU, DIoU, CIoU, or EIoU between two boxes, supporting xywh/xyxy formats.
    ...
    if CIoU or DIoU or GIoU or EIoU:
        ...
        if CIoU or DIoU or EIoU:  # Distance, Complete, or Efficient IoU
            ...
            if EIoU:
                ...
                w_diff2 = (w1 - w2) ** 2
                h_diff2 = (h1 - h2) ** 2
                return iou - (rho2 / c2 + w_diff2 / cw2 + h_diff2 / ch2)  # EIoU
