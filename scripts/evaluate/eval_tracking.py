        ...
        try:
            ...
            for frame_idx, frame_path_or_frame in enumerate(frame_list):
                ...
                if tracker and tracker != 'mock_tracker':
                    try:
                        tracking_results = tracker.update(det_boxes, confidences, classes)
                        current_track_count = len(tracking_results.tracks)
